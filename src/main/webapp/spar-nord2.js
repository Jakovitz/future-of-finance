...
<p>\
<img src="https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/swipp.svg" style="height: 26px; width: auto; position: relative; top: 4px;" /> <a id="microinject-init" href="onclick();" style="text-decoration: none;">Doner beløb</a>\
</p>';
...
(function ($) {
    ...
    $('div.intro').find('div.rgt').find('img').attr('src', 'https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/image.jpg');
    $('div.intro').find('div.rgt').find('img').attr('data-original', 'https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/image.jpg');
    $('div.intro').find('div.rgt').find('img').attr('src', 'https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/image.jpg');
    ...
    $('body').append('<div id="microinject-dialog" title="Betal med Swipp">\
        ...
        <a class="buy" style="margin-top: 17px;"><img src="https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/swipp.svg" style="height: 22px;"><span style="float: right;">Kr. 5</span></a>\
        <a class="buy"><img src="https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/swipp.svg" style="height: 22px;"><span style="float: right;">Kr. 10</span></a>\
        <a class="buy"><img src="https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/swipp.svg" style="height: 22px;"><span style="float: right;">Kr. 20</span></a>\
        <a id="microinject-buy" class="buy"><img src="https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/swipp.svg" style="height: 22px;"><span style="float: right;">Kr. 50</span></a>\
    </div>');

    $('body').append('<div id="microinject-receipt-dialog" title="Bekræft donationen">\
        <a id="microinject-confirm" class="buy"><img src="https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/swipp.svg" style="height: 22px;"><span style="float: right;">Kr. 50</span></a>\
    </div>');
        ...
        var transact = function (e) {
            ...
            $('#microinject-confirm').on('click', function (e) {
                ...
                setTimeout(function () {
                    ...
                    $('#microinject-confirm').html('<img src="https://raw.githubusercontent.com/Jakovitz/future-of-finance/master/src/main/webapp/swipp.svg" style="height: 22px;"><span style="float: right;">Projektet modtager 100,-</span>');
                }, 300);
